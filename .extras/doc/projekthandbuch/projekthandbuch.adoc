...
."AbteilungGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,AbteilungGetController,svg]
----
include::AbteilungGetController.plantuml[]
----
...
."AbteilungWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,AbteilungGetController,svg]
----
include::AbteilungWriteController.plantuml[]
----
...
.AbteilungQueryResolver für Lesezugriffe an der GraphQL-Schnittstelle
[plantuml,AbteilungQueryResolver,svg]
----
include::AbteilungQueryResolver.plantuml[]
----

Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a
pellentesque nec, egestas non nisi.

.AbteilungMutationResolver für Schreibzugriffe an der GraphQL-Schnittstelle
[plantuml,AbteilungMutationResolver,svg]
----
include::AbteilungMutationResolver.plantuml[]
----
...
."AbteilungReadService" von der Geschäftslogik
[plantuml,AbteilungReadService,svg]
----
include::AbteilungReadService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."AbteilungWriteService" von der Geschäftslogik
[plantuml,AbteilungWriteService,svg]
----
include::AbteilungWriteService.plantuml[]
----
...
.Entity
[plantuml,Abteilung,svg]
----
include::Abteilung.plantuml[]
----
