...
--        chown postgres:postgres /var/lib/postgresql/tablespace/abteilung
...
-- (5) 2. PowerShell:
--     docker compose exec db bash
--        psql --dbname=postgres --username=postgres --file=/sql/create-db-abteilung.sql
--        psql --dbname=abteilung --username=abteilung --file=/sql/create-schema-abteilung.sql
--        exit
--      docker compose down
