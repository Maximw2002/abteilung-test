...
-- docker compose exec db sqlplus SYS/p@FREEPDB1 as SYSDBA '@/sql/create-user-abteilung.sql'
-- docker compose exec db sqlplus abteilung/p@FREEPDB1 '@/sql/create-schema-abteilung.sql'
-- docker compose exec db sqlplus abteilung/p@FREEPDB1 '@/sql/create.sql'
...
GRANT
  ...
  DROP ANY INDEX
TO abteilung;
GRANT READ, WRITE ON DIRECTORY csv_dir TO abteilung;
GRANT UNLIMITED TABLESPACE TO abteilung;
...
-- DROP TABLESPACE abteilungspace INCLUDING CONTENTS AND DATAFILES;
-- CREATE TABLESPACE abteilungspace DATAFILE 'abteilung.dbf' SIZE 10M;
