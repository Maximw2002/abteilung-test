...
# Aufruf:   docker build --tag juergenzimmermann/abteilung:2024.04.0-bookworm .
#               ggf. --progress=plain
#               ggf. --no-cache
...
LABEL org.opencontainers.image.title="abteilung" \
    org.opencontainers.image.description="Appserver abteilung mit Basis-Image Debian Bookworm" \
